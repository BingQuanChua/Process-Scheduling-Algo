...
public class ProcessNotUsed implements Comparable<ProcessNotUsed> {
	...
	public ProcessNotUsed(int process, int at, int bt, int priority) {
	...
	public int compareTo(ProcessNotUsed p) {
